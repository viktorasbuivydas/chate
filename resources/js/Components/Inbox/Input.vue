<template>
    <div class="w-full">
        ...
        <form class="" @submit.prevent="submit">
            ...
            <div
                class="flex grow items-center px-3 py-2 bg-gray-50 dark:bg-gray-700"
            >
                <button
                    type="button"
                ...
                <input
                    ...
                    id="chat"
                    autocomplete="off"
                    class="block mx-1 sm:mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:outline-none"
