<template>
    <AppLayout>
        ...
        <div class="relative mt-2">
            <div
                class="max-h-[calc(100vh-125px)] grid grid-cols-3 gap-5 w-full overflow-y-auto"
            >
                    ...
                    <div class="min-h-[calc(100vh-150px)] bg-gray-800 p-4">
                        ...
                        >
                            <div class="place-self-start">
                                <div
                                    class="bg-indigo-500 text-white p-4 rounded-2xl rounded-tl-none"
                                >
                                    Labas, kaip gyvuoji???
                                </div>
                            </div>
                            ...
                            <div class="place-self-end text-right">
                                <div
                                    class="bg-blue-500 text-white p-4 rounded-2xl rounded-tr-none"
                                >
                                    Sveikas, visai neblogai. Kaip tu?
                                </div>
                            </div>
                        </div>
                    </div>
